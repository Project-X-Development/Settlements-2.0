...
public enum MessageType {
	...
	ALLIANCE_MEMBER_DAMAGE(PREFIX.getMsg() + "&dYou cannot hurt members of your own alliance!"),
	ALLIANCE_INVITE_SENT(PREFIX.getMsg() + "&7Alliance invite sent to &b<settlement>"),
	ADMIN_OVERRIDE_START(PREFIX.getMsg() + "&4Admin override enabled!"),
	ADMIN_OVERRIDE_END(PREFIX.getMsg() + "&4Admin override disabled!"),
