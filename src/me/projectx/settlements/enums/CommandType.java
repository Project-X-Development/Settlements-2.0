...
public enum CommandType {
	...
	SETTLEMENT_ALLY_ACCEPT("/s acceptally <Settlement>", "Accept a Settlement's alliance request", "settlements.player.ally.accept"),
	SETTLEMENT_ALLY_DENY("/s denyally <Settlement>", "Deny a Settlement's alliance request", "settlements.player.ally.deny"),
